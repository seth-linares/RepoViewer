...
impl UI {
    ...
    pub fn render(frame: &mut Frame, app: &App) {
        ...
        let chunks = Layout::default()
            ...
            .constraints([
                ...
                Constraint::Length(4),  // Status bar (fixed height)
            ])
            .split(frame.area());
    ...
    fn render_status_bar(frame: &mut Frame, app: &App, area: Rect) {
        ...
        let controls = vec![
            ...
            // Quit control on its own line to avoid crowding
            Line::from(vec![
            ...
            Line::from(vec![
                ...
                Span::raw(" Copy tree to clipboard"),
            ]),
        ];
    ...
    fn render_message(frame: &mut Frame, message: &crate::app::Message) {
        ...
        let color = if message.success { Color::Green } else { Color::Red };
        let block = Block::default()
            .title(if message.success { " Success " } else { " Notice " })
            .borders(Borders::ALL)
